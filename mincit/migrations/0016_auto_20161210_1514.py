...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('si', 'Si'), ('no', 'No')],
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[('si', 'Si'), ('mas o menos', 'Mas o Menos'),
                         ('no', 'No')], default='No seleccion', max_length=29),
        ),
        migrations.AlterField(
            model_name='organizacion',
        ...
        migrations.AlterField(
            ...
            name='elabora_planes',
            field=models.CharField(
                choices=[('semanales', 'Semanales'), ('mensuales', 'Mensuales'),
                         ('trimestrales', 'Trimestrales'),
                         ('semestrales', 'Semestrales'), ('anuales', 'Anuales'),
                         ('largo_plazo', 'Largo Plazo')],
                default='No seleccion', max_length=50),
        ),
        migrations.AlterField(
            model_name='planeacion',
