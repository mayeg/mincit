...
urlpatterns = [
    ...
    url(r'^diagnostico_emp/situacion/([\d+])/$', views.SituacionViews.as_view(),
        name='situacion'),
    url(r'^diagnostico_emp/situacion/crear/([\d+])/$', views.SituacionCreateViews.as_view(),
    ...
    url(r'^diagnostico_emp/planeacion/([\d+])/$', views.PlaneacionViews.as_view(),
        name='planeacion'),
    url(r'^diagnostico_emp/planeadion/crear/([\d+])/$', views.PlaneacionCreateViews.as_view(),
